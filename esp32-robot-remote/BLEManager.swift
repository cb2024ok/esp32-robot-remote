...
class BLEManager: NSObject, ObservableObject, CBCentralManagerDelegate, CBPeripheralDelegate  {
    // Constants specific to the ESP32 BLE service and characteristic UUIDs.
            enum ESP32Constants {
                static let serviceUUID = "fafafafa-abcd-4321-abcd-fafafafafafa"
                static let characteristicUUID = "12345678-1234-5678-1234-567812345678"
            }
            ...
            func centralManager(_ central: CBCentralManager, didDiscover peripheral: CBPeripheral, advertisementData: [String: Any], rssi RSSI: NSNumber) {
                print(peripheral)
                if peripheral.name?.contains("nimble") ?? false {
                ...
                if let characteristics = service.characteristics {
                    for characteristic in characteristics {
                        if characteristic.properties.contains(.write) {
                            ...
                            print("Connected to ESP32-Robot Control Characteristic")
                        }
                    }
                }
            }
